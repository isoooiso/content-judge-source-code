  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-indigo-950 to-fuchsia-950 flex items-center justify-center px-4">
      <div className="bg-slate-900/70 border border-indigo-500/20 rounded-3xl shadow-2xl p-10 max-w-xl w-full text-center fade-in">
        ...
        <h1 className="text-3xl font-extrabold text-slate-50 tracking-tight">Content Judge</h1>
        <p className="text-slate-300 mt-3">
          Paste your idea, post, or project description. On-chain AI will rate originality, clarity, and value.
        </p>
        ...
        <p className="text-xs text-slate-400 mt-8">
          This is an AI-based evaluation for fun and iteration — not legal or financial advice.
        </p>
      </div>
    </div>
  )
